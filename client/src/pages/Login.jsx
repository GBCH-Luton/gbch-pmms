...
<div style={{ marginBottom: '40px', textAlign: 'center' }}>
  ...
  <h1 style={{ fontSize: '36px', fontWeight: 800, color: COLORS.white, margin: '0 0 6px 0', letterSpacing: '-0.03em', lineHeight: 1 }}>
    PMMS
  </h1>
  <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.45)', margin: 0, fontWeight: 500 }}>
    Property Maintenance Management System
        ...
        <div style={{
          ...
          <p style={{ fontSize: '16px', fontWeight: 700, color: COLORS.white, margin: '0 0 24px 0' }}>Sign in to your account</p>
